...
var _process$env = process.env,
  POSTGRES_DATABASE = _process$env.POSTGRES_DATABASE,
...
var Database = new _sequelize.Sequelize(POSTGRES_DATABASE, POSTGRES_USER, POSTGRES_PASSWORD, {
  host: POSTGRES_HOST,
  port: POSTGRES_PORT,
  dialect: 'postgres',
  dialectModule: _pg["default"],
  dialectOptions: {
    ssl: {
      require: true,
...
Database.addHook('beforeValidate', function (instance) {
  for (var key in instance.dataValues) {
