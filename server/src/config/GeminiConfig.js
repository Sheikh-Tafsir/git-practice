...
import { processImageFiles, processImageUrls } from "../utils/ImageUtils";
...
export const chat = async (chatHistory, prompt) => {
  console.log("here");
...
export const textAndImageUrl = async (prompt, image) => {  
    const imageArray = [];
...
export const textAndImageFile = async (prompt, image) => {  
  const images = [];
  images.push(image);
